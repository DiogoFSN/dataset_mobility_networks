...
mydir = os.getcwd()
path_xlsx = mydir + "\\saopaulo_mobility_network\\Network_all_trips\\raw_data\\All_trips.xlsx"
atributos = mydir + "\\saopaulo_mobility_network\\Network_all_trips\\raw_data\\centroides_zonasSP.csv"
