...
mydir = os.getcwd()
path_xlsx = mydir + "\\br_sao_paulo_mobility_network_by_subway_in_2017\\Network_all_trips\\raw_data\\All_trips.xlsx"
atributos = mydir + "\\br_sao_paulo_mobility_network_by_subway_in_2017\\Network_all_trips\\raw_data\\centroides_zonasSP.csv"
