...
path_xlsx = mydir + "\\IBGE_2016_mobilidade_covid-masters\\main_code\\input_data\\raw_data\\Base_de_dados_ligacoes_rodoviarias_e_hidroviarias_2016.xlsx"
#print('path_xlsx: ', path_xlsx)
...
data.to_excel(mydir + "\\IBGE_2016_mobilidade_covid-masters\\main_code\\input_data\\raw_data\\dataset_transform.xlsx", encoding="utf8")

## Carregando o dataset
data = pd.read_excel(mydir + "\\IBGE_2016_mobilidade_covid-masters\\main_code\\input_data\\raw_data\\dataset_transform.xlsx", header=0)
#print('data: ', data)
...
def build_graph(data, directed=False):
    ...
    ## Salvar grafo
    g1.write_graphml(mydir + "\\IBGE_2016_mobilidade_covid-masters\\main_code\\input_data\\networks\\grafo_completo.GraphML")
    g2.write_graphml(mydir + "\\IBGE_2016_mobilidade_covid-masters\\main_code\\input_data\\networks\\grafo_peso_hidro.GraphML")
    g3.write_graphml(mydir + "\\IBGE_2016_mobilidade_covid-masters\\main_code\\input_data\\networks\\grafo_peso_rodo.GraphML")
    g4.write_graphml(mydir + "\\IBGE_2016_mobilidade_covid-masters\\main_code\\input_data\\networks\\grafo_peso_somado.GraphML")
