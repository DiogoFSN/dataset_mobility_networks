...
mydir = os.getcwd()
## store file path
path_xlsx = mydir + "\\road_and_waterway_connections_IBGE_2016\\input_data\\raw_data\\Base_de_dados_ligacoes_rodoviarias_e_hidroviarias_2016.xlsx"
...
data.to_excel(mydir + "\\road_and_waterway_connections_IBGE_2016\\input_data\\raw_data\\dataset_transform.xlsx", encoding="utf8")

## Loading the dataset
data = pd.read_excel(mydir + "\\road_and_waterway_connections_IBGE_2016\\input_data\\raw_data\\dataset_transform.xlsx", header=0)
...
def build_graph(data, directed=False):
    ...
    ## save graph
    g1.write_graphml(mydir + "\\road_and_waterway_connections_IBGE_2016\\input_data\\networks\\grafo_completo.GraphML")
    g2.write_graphml(mydir + "\\road_and_waterway_connections_IBGE_2016\\input_data\\networks\\grafo_peso_hidro.GraphML")
    g3.write_graphml(mydir + "\\road_and_waterway_connections_IBGE_2016\\input_data\\networks\\grafo_peso_rodo.GraphML")
    g4.write_graphml(mydir + "\\road_and_waterway_connections_IBGE_2016\\input_data\\networks\\grafo_peso_somado.GraphML")
