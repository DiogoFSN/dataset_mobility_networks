...
mydir = os.getcwd()
files = os.listdir(mydir + '\\road_and_waterway_connections_IBGE_2016\\input_data\\networks')
...
for file in files:
    ...
    ## metrics folders
    relative_path_in = mydir + '\\road_and_waterway_connections_IBGE_2016\\results\\metrics\\' + file[:-8] + '\\in\\'
    relative_path_out = mydir + '\\road_and_waterway_connections_IBGE_2016\\results\\metrics\\' + file[:-8] + '\\out\\'
    relative_path_time = mydir + '\\road_and_waterway_connections_IBGE_2016\\results\\metrics\\' + file[:-8] + '\\time\\'
    relative_path_cost = mydir + '\\road_and_waterway_connections_IBGE_2016\\results\\metrics\\' + file[:-8] + '\\cost\\'
    ...
    for j in entrada:
        for metric in metrics:
            ...
            df = pd.read_csv(mydir + '\\road_and_waterway_connections_IBGE_2016\\results\\metrics\\' + file[:-8] + '\\' + j + '\\' + metric + '.csv', delimiter=';',
            ...
            ig.plot(g, mydir + '\\road_and_waterway_connections_IBGE_2016\\results\\metrics\\' + file[:-8] + '\\' + j + '\\' + metric + '.png', **visual_style)
