...
for file in files:
    ...
    g = ig.Graph.Read_GraphML(mydir + '\\road_and_waterway_connections_IBGE_2016\\main_code\\input_data\\networks\\' + file)
    ...
    ## metrics folder
    relative_path = mydir + '\\road_and_waterway_connections_IBGE_2016\\main_code\\results\\clusters\\' + file[:-8]
    ...
    for j in entrada:
        ...
        Path(mydir + '\\road_and_waterway_connections_IBGE_2016\\main_code\\results\\clusters\\' + file[:-8] + '\\' + j + '\\').mkdir(parents=True, exist_ok=True)
        ig.plot(infomap, mydir + '\\road_and_waterway_connections_IBGE_2016\\main_code\\results\\clusters\\' + file[:-8] + '\\' + j + '\\' + 'infomap' + '.png', **visual_style)
        ig.plot(walktrap, mydir + '\\road_and_waterway_connections_IBGE_2016\\main_code\\results\\clusters\\' + file[:-8] + '\\' + j + '\\' + 'walktrap' + '.png', **visual_style)
        # ig.plot(GirvanNewman, mydir + '\\road_and_waterway_connections_IBGE_2016\\main_code\\results\\clusters\\' + file[:-8] + '\\' + j + '\\' + 'GirvanNewman' + '.png',
        #         **visual_style)
        # ig.plot(louvain, mydir + '\\road_and_waterway_connections_IBGE_2016\\main_code\\results\\clusters\\' + file[:-8] + '\\' + j + '\\' + 'louvain' + '.png', **visual_style)
